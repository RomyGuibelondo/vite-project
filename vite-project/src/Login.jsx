...
function Login() {
    ...
    return (
        <>
            <div style={{backgroundColor}} className="h-screen grid content-center justify-center dark:text-white ">
            <input className="absolute" type="color" value={backgroundColor} onChange={handleColorChange} />      
                <div className="w-full  gap-5 grid text-xl bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 p-6 dark:border-gray-700 ">
                    <div>{error && error} </div>
                    ...
                    <form className="gap-5 grid" onSubmit={handleSubmit}>
                        ...
                        <button className="font-medium text-primary-600 hover:underline dark:text-primary-500" type="submit">Log in</button>
